...
class FillPermissionsForSegobra extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSegobra constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.segobra',
            'admin.segobra.index',
            'admin.segobra.create',
            'admin.segobra.show',
            'admin.segobra.edit',
            'admin.segobra.delete',
            'admin.segobra.bulk-delete',
        ]);
